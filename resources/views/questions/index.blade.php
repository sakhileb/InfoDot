    ...
    <main class="px-4 pb-12 pt-8 sm:px-6 lg:px-10" style="font-family:'Inter',sans-serif;">
        <div class="mx-auto w-full max-w-7xl">
            <div class="mb-10 flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
                <div>
                    <h2 class="text-4xl font-extrabold tracking-tight text-[#dae2fd]" style="font-family:'Manrope',sans-serif;">Questions</h2>
                ...
                <a href="{{ route('seek') }}" class="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#2962ff] to-[#004ee8] px-7 py-3 text-sm font-bold tracking-tight text-[#f7f5ff] shadow-[0_8px_24px_rgba(41,98,255,0.25)] transition hover:shadow-[0_12px_32px_rgba(41,98,255,0.4)]" style="font-family:'Manrope',sans-serif;">
            ...
            @forelse ($questions as $question)
                ...
                @endphp
                <a href="{{ route('questions.view', ['qid' => $question->id]) }}" class="mb-6 block rounded-3xl border border-[#434656]/40 p-6 shadow-[0_20px_44px_rgba(0,0,0,0.32)] transition hover:-translate-y-0.5 hover:border-[#8d90a2]/60" style="background:rgba(49,57,77,0.6);backdrop-filter:blur(20px);">
                    <div class="flex items-start justify-between gap-4">
                        <h3 class="text-xl font-bold tracking-tight text-[#dae2fd]" style="font-family:'Manrope',sans-serif;">{{ $question->question }}</h3>
            ...
            @empty
                <section class="relative flex min-h-[420px] flex-col items-center justify-center">
                    ...
                    <div class="relative w-full max-w-2xl rounded-[2rem] border border-[#434656]/30 p-12 text-center shadow-[0_32px_64px_rgba(0,0,0,0.4)]" style="background:rgba(49,57,77,0.6);backdrop-filter:blur(20px);">
                        <h3 class="text-2xl font-bold tracking-tight text-[#dae2fd]" style="font-family:'Manrope',sans-serif;">No questions yet.</h3>
